...
const demo = async () => {
  ...
  // Make a prediction through the locally hosted example.png.
  const exampleElement = document.getElementById('example');
  if (exampleElement.complete && exampleElement.naturalHeight !== 0) {
    predict(exampleElement);
    exampleElement.style.display = '';
  } else {
    exampleElement.onload = () => {
      predict(exampleElement);
      exampleElement.style.display = '';
    }
  }
